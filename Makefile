...
#    Updated: 2022/10/22 21:34:45 by iecharak         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c       ft_isalpha.c    ft_memchr.c     ft_memset.c     ft_putstr_fd.c  ft_strlcat.c    ft_strnstr.c    ft_tolower.c \
		...
		ft_isalnum.c    ft_isprint.c    ft_memmove.c    ft_putnbr_fd.c  ft_strjoin.c    ft_strncmp.c    ft_substr.c ft_split.c	ft_strmapi.c\
		ft_striteri.c\
